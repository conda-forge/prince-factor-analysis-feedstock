About prince-factor-analysis-feedstock
======================================
...
Documentation: https://github.com/MaxHalford/prince
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/prince-factor-analysis-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/prince-factor-analysis-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add prince-factor-analysis
# for installing globally
pixi global install prince-factor-analysis
```
...
It is possible to list all of the versions of `prince-factor-analysis` available on your platform:
...
```
pixi search prince-factor-analysis --channel conda-forge
```
